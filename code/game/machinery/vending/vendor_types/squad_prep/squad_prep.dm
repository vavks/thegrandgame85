...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/rmc/populate_product_list(scale)
	listed_products = list(
		...
		list("Royal Marine Uniform", round(scale * 10), /obj/item/clothing/under/marine/twe/rmc, VENDOR_ITEM_REGULAR),
		...
		list("OOCUHM Cam-Gear", round(scale * 10), /obj/item/device/overwatch_camera/twe, VENDOR_ITEM_REGULAR),
