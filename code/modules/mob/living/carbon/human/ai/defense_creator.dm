...
/datum/human_defense_creator_menu/ui_static_data(mob/user)
	...
	data["valid_factions"] = list(FACTION_MARINE, FACTION_UA_REBEL, FACTION_UPP, FACTION_CANC, FACTION_WY, FACTION_FREELANCER, FACTION_RMC, FACTION_TWE_REBEL, FACTION_MERCENARY)
