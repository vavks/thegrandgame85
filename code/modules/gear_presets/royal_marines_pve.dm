...
/datum/equipment_preset/uscm/rmc/synth/load_gear(mob/living/carbon/human/new_human)
	...
	//head
	new_human.equip_to_slot_or_del(new /obj/item/clothing/head/cmcap/royal_marine/team_leader, WEAR_HEAD)
	//uniform
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/marine/twe/rmc, WEAR_BODY)
	...
	new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/rifle/nsg23/rmc/unloaded, WEAR_J_STORE)
	//back
