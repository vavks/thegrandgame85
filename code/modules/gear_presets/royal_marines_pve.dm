...
/datum/equipment_preset/uscm/rmc/synth
	...
	access = list(ACCESS_WY_GENERAL, ACCESS_WY_FLIGHT, ACCESS_TWE_ENGINEERING, ACCESS_TWE_COMMANDO, ACCESS_TWE_LEADERSHIP, ACCESS_TWE_TLPREP, ACCESS_TWE_ARMORY, ACCESS_TWE_HEVWEAPPREP, ACCESS_TWE_SNIPERPREP, ACCESS_TWE_ENGPREP, ACCESS_TWE_MEDICAL)
