...
#define JOB_TWE_RMC_SYNTH "Combat Synthetic"

#define TWE_COMMANDO_JOB_LIST list(JOB_TWE_RMC_RIFLEMAN, JOB_TWE_RMC_MEDIC, JOB_TWE_RMC_ENGI, JOB_TWE_RMC_BREACHER, JOB_TWE_RMC_SMARTGUNNER, JOB_TWE_RMC_MARKSMAN ,JOB_TWE_RMC_TEAMLEADER, JOB_TWE_RMC_SECTIONLEADER, JOB_TWE_RMC_TROOPLEADER, JOB_TWE_RMC_LIEUTENANT, JOB_TWE_RMC_COMMANDER, JOB_TWE_RMC_SYNTH,)

//-------- IASF --------//

#define JOB_TWE_IASF_RIFLEMAN "Trooper"
#define JOB_TWE_IASF_MEDIC "Medic"
#define JOB_TWE_IASF_ENGI "Sapper"
#define JOB_TWE_IASF_SMARTGUNNER "GPMG Gunner"
#define JOB_TWE_IASF_TEAMLEADER "Team Leader"
#define JOB_TWE_IASF_SECTIONLEADER "Section Leader"
#define JOB_TWE_IASF_TROOPLEADER "Troop Sergeant"
#define JOB_TWE_IASF_LIEUTENANT "Troop Commander"
#define JOB_TWE_IASF_COMMANDER "Squadron Commander"
